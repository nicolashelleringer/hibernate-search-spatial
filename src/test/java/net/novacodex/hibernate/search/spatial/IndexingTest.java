...
public class IndexingTest {
	...
	public void IndexingTest() {
		...
		try {
			...
			org.junit.Assert.assertEquals(0,results2.size());
			...
			org.junit.Assert.assertEquals(0,results3.size());
			...
			org.junit.Assert.assertEquals(0,results4.size());
			...
			org.junit.Assert.assertEquals(1,results5.size());
